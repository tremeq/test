...
/**
 * Abstract class to manage SkinSources with offline mode support.
 * Enhanced version that supports retrieving skins by player name.
 */
public abstract class SkinSource {
     ...
     */
    public abstract BaseComponent[] getHead(OfflinePlayer player, boolean overlay);

    /**
     * NEW: Retrieves a 8x8 grid of pixels representing a players head using the player's name.
     * This method is crucial for offline mode servers where UUID is cracked.
     *
     * @param playerName The name of the player whose head is to be retrieved.
     * @param overlay    A boolean value indicating whether to apply overlay on the players head.
     * @return           An array of BaseComponents representing the player's head.
     */
    public abstract BaseComponent[] getHeadByName(String playerName, boolean overlay);
     ...
     * @return An array of strings representing the hexadecimal color codes of pixels.
     */
